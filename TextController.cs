	...
	public class TextController : MonoBehaviour {
		...
		public enum States {intro, elizabeth, michael, jacob, hannah, askConductor, interrogate, body, solve, whySolve, fail, fail2, success};
	...
	void  Start (){ 
		...
		void  Update (){
			print (myState);
		if (myState == States.elizabeth) {
			state_elizabeth ();		} else if (myState == States.intro) {			state_intro ();		}
